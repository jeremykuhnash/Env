...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(vi-tilde-fringe evil-search-highlight-persist package.)
...
in `dotspacemacs/user-config' first."
  (setq spacemacs-buffer--warnings nil
        ...
        default-frame-alist '((top . 70) (left . 70)
                              (width . 90) (height . 60)
